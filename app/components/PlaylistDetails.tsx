    ...
    const columns = useMemo<Column<Track>[]>(
        () => [
            ...
            },
            {
                ...
                sortType: (a: { original: { audioFeatures: { danceability: any; }; }; }, b: { original: { audioFeatures: { danceability: any; }; }; }) => {
            ...
            },
            {
                ...
                sortType: (a: { original: { audioFeatures: { energy: any; }; }; }, b: { original: { audioFeatures: { energy: any; }; }; }) => {
            ...
            },
            {
                ...
                sortType: (a: { original: { audioFeatures: { key: any; }; }; }, b: { original: { audioFeatures: { key: any; }; }; }) => {
            ...
            },
            {
                ...
                sortType: (a: { original: { audioFeatures: { loudness: any; }; }; }, b: { original: { audioFeatures: { loudness: any; }; }; }) => {
            ...
            },
            {
                ...
                sortType: (a: { original: { audioFeatures: { speechiness: any; }; }; }, b: { original: { audioFeatures: { speechiness: any; }; }; }) => {
            ...
            },
            {
                ...
                sortType: (a: { original: { audioFeatures: { acousticness: any; }; }; }, b: { original: { audioFeatures: { acousticness: any; }; }; }) => {
            ...
            },
            {
                ...
                sortType: (a: { original: { audioFeatures: { instrumentalness: any; }; }; }, b: { original: { audioFeatures: { instrumentalness: any; }; }; }) => {
            ...
            },
            {
                ...
                sortType: (a: { original: { audioFeatures: { liveness: any; }; }; }, b: { original: { audioFeatures: { liveness: any; }; }; }) => {
            ...
            },
            {
                ...
                sortType: (a: { original: { audioFeatures: { valence: any; }; }; }, b: { original: { audioFeatures: { valence: any; }; }; }) => {
            ...
            },
            {
                ...
                sortType: (a: { original: { audioFeatures: { tempo: any; }; }; }, b: { original: { audioFeatures: { tempo: any; }; }; }) => {
            ...
            },
            {
                ...
                sortType: (a: { original: { durationMs: any; }; }, b: { original: { durationMs: any; }; }) => {
            ...
            },
            {
                ...
                sortType: (a: { original: { audioFeatures: { timeSignature: any; }; }; }, b: { original: { audioFeatures: { timeSignature: any; }; }; }) => {
